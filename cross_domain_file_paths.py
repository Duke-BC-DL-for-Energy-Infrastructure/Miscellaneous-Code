...
for img in training_paths:
    training_imgs.write('../data/images/' + img.split('\\')[-1] + '\n')
    training_lbls.write('../data/labels/' + img.split('\\')[-1].replace('.jpg', '.txt') + '\n')
training_imgs.close()
training_lbls.close()
...
for img in validation_paths:
    validation_imgs.write('../data/images/' + img.split('\\')[-1] + '\n')
    validation_lbls.write('../data/labels/' + img.split('\\')[-1].replace('.jpg', '.txt') + '\n')
...
for img in synthetic_paths:
    synthetic_imgs.write('../data/synthetic_images/' + img.split('\\')[-1] + '\n')
    synthetic_lbls.write('../data/synthetic_labels/' + img.split('\\')[-1].replace('.png', '.txt') + '\n')
